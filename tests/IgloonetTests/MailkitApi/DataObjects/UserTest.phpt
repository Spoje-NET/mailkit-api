...
class UserTest extends Tester\TestCase
{
	public function testBase()
	{
		...
		$user->setStatus(\Igloonet\MailkitApi\DataObjects\Enums\UserStatus::from('enabled'));
		...
		$user->setGender(\Igloonet\MailkitApi\DataObjects\Enums\Gender::from('M'));
		...
		Assert::same(\Igloonet\MailkitApi\DataObjects\Enums\UserStatus::from('enabled'), $user->getStatus());
		...
		Assert::same(\Igloonet\MailkitApi\DataObjects\Enums\Gender::from('M'), $user->getGender());
