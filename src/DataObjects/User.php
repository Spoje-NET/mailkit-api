...
class User
{
    ...
    {
        self::assertValidCustomFieldNumber($fieldNumber);
    ...
    private static function isValidGender(string $gender): bool
    {
        return \in_array(trim($gender), array_merge(
            array_column(Gender::cases(), 'value'),
            ['male', 'female', 'muz', 'zena', 'm', 'f'],
        ), true);
    }

    private static function isValidCustomFieldNumber(int $fieldNumber): bool
    {
     ...
     * @throws InvalidCustomFieldNumberException
     */
    private static function assertValidCustomFieldNumber(int $fieldNumber): bool
    {
        if (!self::isValidCustomFieldNumber($fieldNumber)) {
