...
class JsonAdapter extends BaseAdapter
{
    ...
    protected function getContent(string $method, array $params): array
    {
        ...
        $context = stream_context_create(self::getStreamContextOptions($requestData));
     ...
     * @throws JsonException
     */
    private static function getStreamContextOptions(array $data): array
    {
        return [
            'http' => [
                'method' => 'POST',
